...
if __name__ =="__main__":
    ...
    DATA_PATH = 'E:\大数据\研究生课程\FDU-DeepLearningNeuralNetwork\mid-homework\dataset\\'
    train_data_path_2007 = os.path.join(DATA_PATH, 'VOCtrainval_06-Nov-2007', 'VOCdevkit', 'VOC2007')
    #train_data_path_2012 = os.path.join(DATA_PATH, 'VOCtrainval-2012', 'VOCdevkit', 'VOC2012')
    ...
    test_data_path_2007 = os.path.join(DATA_PATH, 'VOCtest_06-Nov-2007', 'VOCdevkit', 'VOC2007')
